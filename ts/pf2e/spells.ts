...
export function loadSpellData(){
    return new Promise((resolve, reject) => {
        ...
        Promise.all(spellFilePromises).then((jsonCollections) => {
            ...
            populateFilterDropDown(spellCatalog, "category-filters", "category", filterSpellCatalog);
            populateFilterDropDown(spellCatalog, "level-filters", "level", filterSpellCatalog);
            populateFilterDropDown(spellCatalog, "tradition-filters", "traditions", filterSpellCatalog);
