...
function spellAutoComplete(inputsHTMLCollection, level) {
            ...
            for (i = 0; i < spellOptions.length; i++) {
                ...
                if (matchIndex != -1) {
                    ...
                    b.addEventListener("click", function (e) {
                        ...
                        var containingInput = Array.from(this.parentElement.parentElement.children).find(child => child.classList.contains("spell-name"));
    ...
    function closeAllLists(elmnt) {
        ...
        for (var i = 0; i < x.length; i++) {
            if (elmnt != x[i] && inputs.indexOf(elmnt) == -1) {
