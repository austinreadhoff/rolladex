"use strict";
var _a = require('electron'), app = _a.app, dialog = _a.dialog, BrowserWindow = _a.BrowserWindow, nativeImage = _a.nativeImage;
var io = require('./json-io-main');
var menu = require('./menu');
var saveTracker = require('./save-tracker-main');
var spells = require('./spells-main'); //not used directly, but gotta load it so it can receive ipc messages
